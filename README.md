...
- [Functionality](#functionality)
 - [API](#api)
    - [Admin.cs](#admincs)
      - [ChangePermissions(id, permission)](#changepermissionsid-permission)
    - [Authorized.cs](#authorizedcs)
      - [Book(bookfields)](#bookbookfields)
      - [CheckBookings(id)](#checkbookingsid)
      - [Review(reviewfields)](#reviewreviewfields)
      - [CancelBooking(id)](#cancelbookingid)
      - [AddHotel(hotelFields)](#addhotelhotelfields)
    - [DBSystem.cs](#dbsystemcs)
      - [GetReviews(id)](#getreviewsid)
      - [GetRoom(id)](#getroomid)
      - [GetUser(id)](#getuserid)
      - [GetHotel(id)](#gethotelid)
    - [HotelAdmin.cs](#hoteladmincs)
      - [UpdateHotelInfo(hotelFields)](#updatehotelinfohotelfields)
      - [UpdateRoom(fields)](#updateroomfields)
    - [HotelOwner.cs](#hotelownercs)
